...
TARIFFS = {
    "Домашній інтернет - 125грн/міс.\n(до 01.01.2026, потім 250 грн/міс.)":
        "Домашній інтернет (125грн до конца 26 года)",
    "Домашній інтернет +TV Start - 125грн/міс.\n(до 01.01.2026, потім 300 грн/міс.)":
        "Домашній інтернет +TV Start (125грн/ до конца 26 года)",
    "Домашній інтернет +TV Pro - 125грн/міс. \n(до 01.01.2026, потім 325 грн/міс.)":
        "Домашній інтернет +TV Pro (125грн до конца 26 года)",
    "Домашній інтернет +TV Max - 125грн/міс.\n(до 01.01.2026, потім 375 грн/міс.)":
        "Домашній інтернет +TV Max (125грн до конца 26 года)"
}
...
async def start(message: types.Message):
    ...
    photo = await bot.send_photo(
        message.chat.id,
        "https://github.com/vdmkie/vodafone-bot/blob/main/%D0%94%D0%BE%D0%B1%D0%B0%D0%B2%D0%B8%D1%82%D1%8C%20%D0%9F%D0%BE%D0%B4%D0%B7%D0%B0%D0%B3%D0%BE%D0%BB%D0%BE_20250810_151721_0000.png"
    )
    ...
    msg = await message.answer(
        ...
        "👉 *Домашній інтернет - 125грн/міс.*\n"
        "*акія діє до 01.01.2026, далі 250 грн/міс.\n\n"

        "👉 *Домашній інтернет + TV Start - 125грн/міс.*\n"
        "*акія діє до 01.01.2026, далі 300 грн/міс.*\n\n"

        "👉 *Домашній інтернет + TV Pro - 125грн/міс.*\n"
        "*акія діє до 01.01.2026, далі 325 грн/міс.*\n\n"

        "👉 *Домашній інтернет + TV Max - 125грн/міс.*\n"
        "*акія діє до 01.01.2026*, далі 375 грн/міс.*\n\n"
...
async def check_coverage(message: types.Message):
    ...
    markup_url.add(
        InlineKeyboardButton(
            ...
            url="https://www.google.com/maps/d/u/0/viewer?mid=1T0wyMmx7jf99vNKMX9qBkqxPnefPbnY&ll=50.45869537257287%2C30.529932392320312&z=11"
        )
    )
    markup_finish = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup_finish.add("Завершити")

    msg1 = await message.answer("🔍 Натисніть кнопку нижче, щоб перевірити покриття:", reply_markup=markup_url)
    msg2 = await message.answer("Коли закінчите — натисніть 'Завершити'", reply_markup=markup_finish)

    user_data[message.chat.id] = {"messages": [msg1.message_id, msg2.message_id], "step": None}
